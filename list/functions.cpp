...
void readFile(list<Student> &tmp, Student &temp, list<Student> nerd, list<Student> noob)
{
    ifstream fd;
...
void generateFile(list<Student> &tmp, Student &temp, list<Student> nerd, list<Student> noob)
{
...
void sortingTest(list<Student> &tmp, Student &temp, list<Student> nerd, list<Student> noob) 
{
    ifstream fd;
    fd.exceptions(std::ios::failbit);
    string fileName;
...
void sortStudents(list<Student> tmp, list<Student> &nerd, list<Student> &noob)
{
    for (auto &i : tmp)
    {
