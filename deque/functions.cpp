...
void readFile(deque<Student> &tmp, Student &temp, deque<Student> nerd, deque<Student> noob)
{
    ifstream fd;
...
void generateFile(deque<Student> &tmp, Student &temp, deque<Student> nerd, deque<Student> noob)
{
...
void sortStudents(deque<Student> tmp, deque<Student> &nerd, deque<Student> &noob)
{
    for (auto &i : tmp)
    {
