...
void printStudents(deque<Student> tmp)
{
    cout << "------------------------------------------------------------------------------------------------------" << endl;
...
void printStudentsToFile(deque<Student> tmp, string fileName)
{   
...
void readFile(deque<Student> &tmp, Student &temp, deque<Student> noob, deque<Student> nerd)
{
    ifstream fd;
...
void generateFile(deque<Student> &tmp, Student &temp, deque<Student> noob)
{
...
void sortingTest(deque<Student> &tmp, Student &temp, deque<Student> noob, deque<Student> nerd)
{
    ifstream fd;
    fd.exceptions(std::ios::failbit);
    string fileName;
...
void sortStudentsMethodOne(deque<Student> tmp, deque<Student> &noob)
{
...
void sortStudentsMethodTwo(deque<Student> tmp, deque<Student> &noob, deque<Student> &nerd)
{
    for (auto &i : tmp)
    {
